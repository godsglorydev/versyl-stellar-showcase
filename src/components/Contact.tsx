      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            Let's <span className="bg-gradient-primary bg-clip-text text-transparent">Start Something</span> Amazing
          </h2>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">hello@versyl.com</p>
                    </div>
                  </div>
              ...
              <Card className="bg-gradient-primary border-primary/20 shadow-glow">
                <CardContent className="p-6">
                  <div className="text-center">
                    <h3 className="font-bold text-primary-foreground mb-2">⚡ Quick Response</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.budget} onValueChange={(value) => handleInputChange('budget', value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="premium-plan">Premium Plan ($2,999/month)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
